...
mob
	...
	verb
		...
		editJutsuApp()
			...
			winset(src, "jutsuApp.notesJutsuApp", "text=\"[current_jutsuApp.notes]\"")
			winset(src, "jutsuApp.rankJutsuApp", "text=\"[current_jutsuApp.app_rank]\"")
