...
mob/proc/button_show_input()
	...
	src << output("[html]<img style='position:absolute; left:0px; top:0px;' src='https://i.postimg.cc/HW63zJQz/buttoncommand1-2.png' onmouseover=this.src='https://i.postimg.cc/HW63zJQz/buttoncommand1-2.png' onmouseout=this.src='https://i.postimg.cc/HW63zJQz/buttoncommand1-2.png' onclick=window.location='byond://?value=inputconfirm'></body><html>", "alert4.button")
	src << output("[html]<img style='position:absolute; left:0px; top:0px;' src='https://i.postimg.cc/HW63zJQz/buttoncommand1-2.png' onmouseover=this.src='https://i.postimg.cc/HW63zJQz/buttoncommand1-2.png' onmouseout=this.src='https://i.postimg.cc/HW63zJQz/buttoncommand1-2.png' onclick=window.location='byond://?value=alertconfirm'></body><html>", "alert.button")
	src << output("[html]<img style='position:absolute; left:0px; top:0px;' src='https://i.postimg.cc/HW63zJQz/buttoncommand1-2.png' onmouseover=this.src='https://i.postimg.cc/HW63zJQz/buttoncommand1-2.png' onmouseout=this.src='https://i.postimg.cc/HW63zJQz/buttoncommand1-2.png' onclick=window.location='byond://?value=alertconfirm'></body><html>", "alert_html.button")
